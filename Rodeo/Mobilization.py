...
class MOB:
    def __init__(self, fi, kenc, kdis, kon, D0, R0, T0, DR0):   # Mobilization model requires these parameters and initial values
...
if __name__ == "__main__":
    ...
    mobilization = MOB(fi, kenc, kdis, kon, D0, R0, T0, DR0)
    solver = ForwardEuler(mobilization)

    solver.set_initial_conditions(mobilization.initial_conditions)
    ...
    fig.suptitle('Plasmid spreading by mobilization')
    plt.show()
